...
def convert_image_to_pdf_page(image, image_width, pdf_width, pdf_density_x):
    print(
        "image_width {} pdf_width {} pdf_density_x {}".format(
    ...
    message = (
        "Generate from the image file “{}” a temporary pdf file with "
        "the density of “{}”"
    )
...
def get_parser():
    ...
    convert_parser = subcmd_args.add_parser(
        "convert",
        aliases=["cv", "c"],
        description="Convert a image file into a PDF file with the same " "dimensions.",
    )
    ...
    replace_parser = subcmd_args.add_parser(
        "replace",
        aliases=["re", "r"],
        description="Replace one page in a PDF file with an image (or an PDF) " "file.",
    )
...
def main():
    ...
    if args.subcmd_args in ["add", "ad", "a"]:
        ...
        message = (
            "Successfully added the image “{}” {} page {} of the PDF "
            "file “{}”. Result: “{}”"
        )
        ...
        message = (
            "Successfully converted the image “{}” to the PDF file "
        ...
        joined_pdf = assemble_pdf(
            main_pdf, insert_pdf, info["page_count"], args.number, mode="replace"
        )
        message = (
            "Successfully replaced page {} of the PDF file “{}” with "
            "the image “{}”. Result: “{}”"
        )
