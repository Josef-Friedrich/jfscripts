...
class TestFunctionCommonPrefix(TestCase):
    def test_single_path(self):
        self.assertEqual(common_path(["/tmp/lol.txt"]), "/tmp")

    def test_two_paths(self):
        self.assertEqual(common_path(["/tmp/a.txt", "/tmp/b.txt"]), "/tmp")

    def test_no_match(self):
        self.assertEqual(common_path(["/usr/a.txt", "/tmp/b.txt"]), "/")
...
class TestFunctionListFiles(TestCase):
    ...
    def test_default_glob(self, os_walk, os_path_isdir):
        ...
        self.assertEqual(
            list_files(["/data"], default_glob="*.txt"), ["/data/a.txt", "/data/b.txt"]
        )
...
class TestFunctionArgparseExamples(TestCase):
    ...
    def test_inline(self):
        ...
        self.assertEqual(doc_examples("test.py", "txt", inline=True), result)
